...
{{--{!! Html::script('node_modules/vue/dist/vue.js')!!}--}}
{{--{!! Html::script('node_modules/bootstrap3/dist/js/bootstrap.min.js')!!}--}}
{!! Html::script('admin/js/index.js?ver=1')!!}
{{--{!! Html::script('admin/js/bootstrap-checkbox.min.js')!!}--}}
{{--{!! Html::script("admin/plugin/persian_date_picker/prism.js") !!}--}}
{{--{!! Html::script("admin/plugin/persian_date_picker/persianDatepicker.min.js") !!}--}}
{{--{!! Html::script("node_modules/amchart3/amcharts/amcharts.js") !!}--}}
{{--{!! Html::script("node_modules/amchart3/amcharts/serial.js") !!}--}}
{{--{!! Html::script("admin/js/serial.js") !!}--}}
{{--{!! Html::script("admin/js/jquery.tagsinput.js") !!}--}}
{{--{!! Html::script("admin/js/validator.js") !!}--}}
{{--{!! Html::script("admin/js/dropZone.js") !!}--}}
{{--{!! Html::script("admin/js/dateConvertor.js") !!}--}}
{{--{!! Html::script("admin/plugin/tinymce/tinymce.min.js") !!}--}}
{{--{!! Html::script("admin/js/short-keys.js") !!}--}}
